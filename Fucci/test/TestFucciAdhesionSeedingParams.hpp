...
#ifndef PROJECTS_FUCCI_TEST_TESTFUCCIADHESIONSEEDINGPARAMS_HPP_
#define PROJECTS_FUCCI_TEST_TESTFUCCIADHESIONSEEDINGPARAMS_HPP_
...
public:
	void TestAdhesion()
	{
		...
		double seedingRand = p_gen->ranf();
		double seeding_probability = 0.04*seedingRand;
...
//		}
		...
		p_random_force->SetMovementParameter(0.3);
		...
		std::string seedingString = std::to_string(seeding_probability);
		std::string outputString = "SeedingDensity" + seedingString;
...
#endif /* PROJECTS_FUCCI_TEST_TESTFUCCIADHESIONSEEDINGPARAMS_HPP_ */
